...
<%
	AuthorizeUtil.UserLoadedJspRedirect(request, response, "Download.jsp", "/download");
 %>
...
<html>
	<head>
		...
		<title>PrintDesk - Download</title>
	</head>
		...
		<div class="card ml-4 mr-4 mt-3 mb-4">
			...
			<div class="card-body p-0">
				<div class="mx-auto w-75 text-center">
					<h1 class="display-4">${printer.GetName()} ${printerdownloadisstartingSavefiletoyourdesktopandthenrunittoinstallprinter}</h1>
					<img class="mb-4 mt-2" src="img/download.png">
				</div>
			</div>
		</div>
	</body>
