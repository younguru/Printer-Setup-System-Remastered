...
<%
	AuthorizeUtil.UserLoadedJspRedirect(request, response, "AdminInstallScriptEdit.jsp", "/admininstallscriptedit");
	...
	<body class="container-fluid" style="min-width: ${MinWidth};">
		...
		<div class="row ml-4 mr-4 mt-3 mb-4">
			<div class="col-3 text-truncate p-4 border-right">
				...
				<p class="mb-1"><img class="size-16" src="img/admin/installscript.png" alt="Install Script page settings"/><a class="ml-2 text-body font-weight-bold" href="${context}/admininstallscript"><u>${Installscript}</u></a> -><img class="size-16" src="img/admin/edit.png" alt="Edit Script"/><a class="ml-2 text-body font-weight-bold" href="${context}/admininstallscriptedit"><u>${Editscript}</u></a></p>
...
<%--				</ul>--%>
				...
				<div class="mb-3">
					<form method="post" action="admininstallscriptedit">
