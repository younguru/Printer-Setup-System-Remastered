		...
		<div class="card ml-4 mr-4 mt-3 mb-4">
			<div class="card-header">
				<div class="d-flex align-items-center">
					<span class="align-middle">${Error404}</span>
				</div>
			</div>
			<div class="card-body p-0">
				<div class="mx-auto w-75 text-center">
					<h1 class="display-1">${Error404}!</h1>
					<h1 class="display-4">${SorryRequestedpagecouldnotbefound}</h1>
					<img class="mb-4 mt-2" src="img/error/error404.gif">
				</div>
			</div>
		</div>
	</body>
